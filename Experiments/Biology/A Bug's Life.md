...
**Mitigation**: Prevent kids from removing magnifying glasses. Take away from kids (and scold demonstrators) if they are deliberately trying to set fire to things. If possible, avoid setting up this experiment somewhere with bright light near the window. 
