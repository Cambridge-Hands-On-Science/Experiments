...
As of summer 2023, everything you need to demonstrate Blood Glucose is contained inside the transparent tupperware labelled 'Blood Glucose'. There are 2 meters that work: 1. ACCU-CHEK Aviva, and 2. SD Codefree. Each only work with their own specific type of test strips. ACCU-Chek Aviva test strips are easier to find in pharmacies, and Codefree test strips are usually only available online (but are cheaper). All other meters in the Blood+Urine box are redundant/out of order/have been discontinued. Test strips are expensive! The more concentrations you make, the more test strips you'll use... I think demonstrating with only 2 concentrations can achieve the same educational outcomes as demonstrating with 5 concentrations. It may be worth it to wait for a group of kids to gather around your table before doing the demo once.
