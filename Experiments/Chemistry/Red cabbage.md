...
Last initially checked on 2023-12-31 by Andrew Marriott (asm206@cam.ac.uk) and double-checked on 2024-01-11 by Asmita Niyogi (an637@cam.ac.uk)
...
1) Cut up half a head of red cabbage (start with less - you may only need a quarter of a head if using warm water).
2) Crush it using a rolling pin. Put crushed cabbage in a bowl/cup with water and mix. The cabbage juice extracts better in warm water - but make sure to use a safe temperature. **DO NOT USE HOT/BOILING WATER**. Strain the liquid into another cup, and you should have a bluish/dark purple liquid – this is your natural indicator. When added to acids it should go pink, and in alkalis or bases it should go blue/green.
...
- This change in the physical structure will change the wavelength of light reflected, and so it changes colour

3) Why does the cabbage juice appear colourful?

- Pigment molecules absorb specific wavelengths of light, determined by their structure
- Rest of the light passes through / reflected; the transmitted & reflected light makes up the colour that we see
- With older kids (KS3/4) - could talk about excitation of electrons, energy levels etc?
...
**Description**: Cabbage juice extracts better in warmer water - demonstrators may be tempted to use hot water to prepare the indicator solution. Hot water carries a risk of serious scalds if spilled on a child / demonstrator.
...
**Check 1**: 2023-12-31 - Andrew Marriott (asm206@cam.ac.uk), **Check 2**: 2024-01-11 - Asmita Niyogi (an637@cam.ac.uk)
