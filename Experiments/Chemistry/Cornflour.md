...
Last initially checked on 2023-01-12 by Peter Methley (pm631@cam.ac.uk) and double-checked on 
...
<!-- This link seems to be broken; commented out for now ([Bromley & Hopkinson reference here](http://personalpages.umist.ac.uk/staff/I.Hopkinson/publications/m17%20-%20Starch%20with%20Beth.pdf)) -->
...
**Mitigation**: Avoid contact with eyes and tell children to as well. Know where the nearest eye was is (there should at least be some in the Safety box).
...
**Check 1**: 2023-01-12 - Peter Methley (pm631@cam.ac.uk), **Check 2**: 
