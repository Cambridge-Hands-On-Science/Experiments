...
- Microwave
- Cardboard
- Butter/Margarine/Cheap Spread (alt. chocolate, anything melty, wax could work and is reusable?)
- Ruler
...
- Explain how light is a wave and that microwaves are just some wavelength of this. A microwave has a generator (called a magnetron), standing waves are formed in the oven box, and the nodes and antinodes have different energy levels (Energy level corresponds to the amplitude squared so antinodes provide maximum heat, nodes have no heating except diffusion). Microwave turntable rotation means food gets heated evenly.
...
- Use the ruler to measure the distance between the hotspots: this gives us half the wavelength of microwaves. (Helpful to draw out for explanation)
...
**Mitigation**: Don't use the microwave for food preparation. Ensure neither the children nor demonstrators ingest any of the demonstration spread used in the experiment. 
